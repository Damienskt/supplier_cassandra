...
public class Main {
    ...
    public static void main( String[] args ) {
        ...
        Main app = new Main(numberOfClients);
        app.executeQueries();
    }

    public Main(int numberOfClients) {
    ...
    public void executeQueries() {
        ...
        long startTime;
        File file = new File("./data/1.txt"); //File path to be changed
        try {
            ...
            while (input != null && input.length() > 0) {
                ...
                if (input.charAt(0) == 'N') {
                    ...
                    try {
                        ...
                        nOT.processOrder(wId, dId, cId, numItems, itemNumbers, supplierWarehouse, quantity);
                    ...
                    try {
                        startTime = System.nanoTime();
                        pT.processPaymentTransaction(wId, dId, cId, payment);
                        long endTime = System.nanoTime() - startTime;
                    ...
                    try {
                        startTime = System.nanoTime();
                        dT.processDeliveryTransaction(wId, carrierId);
                        long endTime = System.nanoTime() - startTime;
                    ...
                    try {
                        startTime = System.nanoTime();
                        oST.processOrderStatus(wId, dId, cId);
                        long endTime = System.nanoTime() - startTime;
                    ...
                    try {
                        startTime = System.nanoTime();
                        sLT.processStockLevelTransaction(wId, dId, new BigDecimal(T), L);
                        long endTime = System.nanoTime() - startTime;
